...
public static class SimplePool
{
	...
	/// </summary>
	/// <param name="obj">GameObject of object that is to be despawned.</param>
	/// /// <param name="container">GameObject under which the given obj GameObject will be stored</param>
	static public void Despawn(GameObject obj, Transform container = null)
	{
